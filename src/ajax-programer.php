<?php
    ...
    if(isset($_POST['amount'])) {
        ...
        $mess .= '<b>Объем:</b>' . $amount . '<br>';
    }
    if(isset($_POST['total'])) {
        $total = substr(htmlspecialchars(trim($_POST['total'])), 0, 100);
        $mess .= '<b>Объем:</b>' . $total . '<br>';
    }
    $mess .= '<hr>';
    ...
    $mail = new PHPMailer();
    $mail->AddAddress('info@fabrika-betona.ru','');   // кому - адрес, Имя
