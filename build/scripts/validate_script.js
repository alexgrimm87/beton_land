    ...
    if ($form.length && $form.attr('novalidate') === undefined) {
        ...
        $form.validate({
            ...
            highlight: function highlight(element, errorClass, validClass) {
                ...
                $(element).closest('.form-field').addClass('error').removeClass('valid');
            ...
            unhighlight: function unhighlight(element, errorClass, validClass) {
                ...
                if ($(element).closest('.form-field').is('.error')) {
                    $(element).closest('.form-field').removeClass('error').addClass('valid');
                }
    ...
    $.ajax({
        ...
        success: function success(data) {
            if (data.trim() == 'true') {
                ...
                $('.js-button').text('Отправлено');
                $('.js-button').addClass('send');
                setTimeout(function () {
                    $('.js-button').text('Отправить заявку');
                    $('.js-button').removeClass('send');
                }, 5000);
            } else {
                thisForm.trigger('reset');
            }
